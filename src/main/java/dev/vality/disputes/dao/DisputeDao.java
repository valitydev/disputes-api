...
public class DisputeDao extends AbstractGenericDao {
    ...
    public void update(UUID disputeId, DisputeStatus status) {
        update(disputeId, status, null, null, null, null);
    }

    public void update(UUID disputeId, DisputeStatus status, LocalDateTime nextCheckAfter) {
        update(disputeId, status, nextCheckAfter, null, null, null);
    }

    public void update(UUID disputeId, DisputeStatus status, String errorMessage) {
        update(disputeId, status, null, errorMessage, null, null);
    }

    public void update(UUID disputeId, DisputeStatus status, Long changedAmount) {
        update(disputeId, status, null, null, changedAmount, null);
    }

    public void update(UUID disputeId, DisputeStatus status, Long changedAmount, Boolean skipCallHgForCreateAdjustment) {
        update(disputeId, status, null, null, changedAmount, skipCallHgForCreateAdjustment);
    }

    private void update(UUID disputeId, DisputeStatus status, LocalDateTime nextCheckAfter, String errorMessage, Long changedAmount, Boolean skipCallHgForCreateAdjustment) {
